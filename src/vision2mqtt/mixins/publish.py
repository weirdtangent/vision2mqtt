        ...
        device = {
            ...
            "cmps": {
                "server": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service_name, "server"),
    ...
    async def publish_camera_discovery(self: Vision2Mqtt, camera_id: str, camera_name: str) -> None:
        ...
        for label in labels:
            cmps[f"presence_{label}"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(f"{camera_name} Vision", f"presence_{label}"),
            ...
            cmps[f"frequency_{label}"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(f"{camera_name} Vision", f"frequency_{label}"),
        ...
        for comp in composites:
            cmps[f"presence_{comp}"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(f"{camera_name} Vision", f"presence_{comp}"),
            ...
            cmps[f"frequency_{comp}"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(f"{camera_name} Vision", f"frequency_{comp}"),
        ...
        cmps["object_count"] = {
            ...
            "obj_id": self.mqtt_helper.obj_id(f"{camera_name} Vision", "object_count"),
        ...
        cmps["last_detection"] = {
            ...
            "obj_id": self.mqtt_helper.obj_id(f"{camera_name} Vision", "last_detection"),
        ...
        cmps["processing_time"] = {
            ...
            "obj_id": self.mqtt_helper.obj_id(f"{camera_name} Vision", "processing_time"),
        ...
        cmps["camera_mode"] = {
            ...
            "obj_id": self.mqtt_helper.obj_id(f"{camera_name} Vision", "camera_mode"),
        ...
        cmps["annotated_image"] = {
            ...
            "obj_id": self.mqtt_helper.obj_id(f"{camera_name} Vision", "annotated_image"),
